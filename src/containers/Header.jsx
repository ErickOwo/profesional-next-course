              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                ...
                <div className="mt-3 px-2 space-y-1">
                  {userNavigation.map((item) => (
                    ...
                    <Disclosure.Button key="Sing out" onClick={()=> logOut()} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">
                      Sing out
                    </Disclosure.Button>
                </div>
              </div>
